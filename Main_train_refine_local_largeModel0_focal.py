...
from params_refine_local_largeModel0 import * 
...
#        saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large0/model_keep.ckpt-24")
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large0/model.ckpt-24000")
	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large0_focal/model.ckpt-1000")
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_more_contaminate_large2/model.ckpt-24000")	
	...
	for step in range(40):
	  ...
	  try:
            file = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_0/'+file_list[file_id][0:-1],'r')	
...
#	    np.random.shuffle(id)
	    ...
	    file_C = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_0/'+file_list[contaminate_id][0:-1],'r')
...
#	    file = scipy_io.loadmat('./test.mat')
#	    image_temp = file['image_list']
...
#	    G_feed_dict = {output_feature_0: feature_no_mask, output_feature_1: feature_mask, ground_truth:masks,G_model.input_features:feature}
	    ...
	    scipy_io.savemat('test_'+str(file_id)+'.mat',{'image':image_temp,'masks':masks_temp,'predict':g_predict})
