...
from params_refine_shuffle_2 import * 
...
def main(argv=None):  # pylint: disable=unused-argument
	...
	""" building training graph """
        ...
        saver_local.restore(sess1, "/scratch/ys1297/LSTM_tracking/source_cross_vgg_local/checkpoints/shuffle_0/cross2/model.ckpt-75000")
