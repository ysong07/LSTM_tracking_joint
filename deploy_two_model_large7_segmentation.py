...
#    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_segmenation/checkpoints_5/test_refine_total_large7_segmentation/model_keep.ckpt-60") 
####  
...
#    np.save('feature_mapping7_segmentation.npy',dict_params)
#    pdb.set_trace()
###
    kernel_size_dec = []
