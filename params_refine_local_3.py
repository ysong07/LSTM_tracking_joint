...
tf.app.flags.DEFINE_string('train_dir', './checkpoints_4/test_refine_total_3',
                            """dir to store trained net""")
tf.app.flags.DEFINE_string('train_file_dir','/scratch/ys1297/LSTM_tracking/data_origin/train_list_3.txt', """dir to read trainlist""")
tf.app.flags.DEFINE_string('test_file_dir','/scratch/ys1297/LSTM_tracking/data_origin/test_list_3.txt', """dir to read trainlist""")
