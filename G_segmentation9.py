...
def feature_extract(batch_frames,mask_frames):
    ...
    return pool4
#feature_mapping_dict =np.load('./feature_mapping7.npy').item()
feature_mapping_dict =np.load('./feature_mapping9_segmentation.npy').item()
def feature_mapping(features_tf):
#    with tf.variable_scope('feature_mapping'):
      f_matrix_0_0 = tf.constant(feature_mapping_dict['matrix_f_0'],name = "matrix_f_0")
      f_bias_0_0 = tf.constant(feature_mapping_dict['bias_f_0'],name = "bias_f_0")

      f_matrix_0_1 = tf.constant(feature_mapping_dict['matrix_f_1'],name = "matrix_f_1")
      f_bias_0_1 = tf.constant(feature_mapping_dict['bias_f_1'],name = "bias_f_1")
...
class G_model_:
  ...
  def define_graph(self):
	...
	output_frame = fill_template(output_template,center,crop_size)
        ...
        return output_frame,output_template, template, mask_template,return_crop_size 

      self.predicts,self.templates,self.original_template,self.mask_template,self.return_crop_size =  forward()
