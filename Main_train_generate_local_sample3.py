...
class Inference:
  def __init__(self,train_file_name):
      ...
      saver_local.restore(self.sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_1/test_refine_total_3/model.ckpt-24000")
      ...
      saver.restore(self.sess,"/scratch/ys1297/LSTM_tracking/source_cross_resnet_globe/checkpoints/iter_2/test_new_no_smooth_share_feature_weight_3/model.ckpt-27000")
...
#          image_array,masks,feature_mask,feature_no_mask,all_features,bbx= Infer.provide_data()
	  ...
	  Infer =  Inference(file_name)
	  Infer.define_graph()
	  file_new = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_3/'+file_name)
