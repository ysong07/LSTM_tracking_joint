...
from params_refine_local_largeModel7 import * 
...
#      tf.gfile.MakeDirs(FLAGS.train_dir) 
	...
	saver_local = tf.train.Saver(variable_collection_local)
        ...
        saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large7/model.ckpt-20000")
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_2/model.ckpt-34000")
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large7_nocontaminate/model.ckpt-16000")	
	...
	mask_stats=0
	  ...
	  try:
	    ...
	    file_C = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_6/'+file_list[contaminate_id][0:-1],'r')
...
#	    summary_writer.add_summary(g_summary, step)
	...
	scipy_io.savemat('./test_7.mat',{'IOU_list':IOU_list}) 
        #acc = acc/600
