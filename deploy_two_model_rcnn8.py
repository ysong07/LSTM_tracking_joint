...
def train(test_file_name):
  ...
  with tf.Graph().as_default():
   ...
   # saver_bbx = tf.train.Saver(variable_collection_bbx)
    saver_bbx.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_bbx8/model.ckpt-20000")
...
#    np.save('feature_mapping8.npy',dict_params)
#    pdb.set_trace()
###
    kernel_size_dec = []
