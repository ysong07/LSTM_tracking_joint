...
#      tf.gfile.MakeDirs(FLAGS.train_dir) 
	...
	""" building training graph """
        ...
        with tf.variable_scope('trainable_params_local') as scope:
 	    ...
 	    h_0 = h_0*tf.nn.tanh(c_0) 
          ...
          G_model = G_model_local_refine(scope="G_model",height=14,width=14,length=16,batch_size = FLAGS.batch_size,layer_num_lstm=1,kernel_size=[3],kernel_num=[256],kernel_size_dec=kernel_size_dec,num_dec_input=[256,128,64,32],num_dec_output=[128,64,32,1],layer_num_cnn =4,initial_h_0=h_0,initial_c_0=c_0)
  ...
  #      saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/onelayer/model.ckpt-8000")
