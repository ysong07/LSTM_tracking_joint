...
def train(test_file_name):
  ...
  with tf.Graph().as_default():
    ...
    saver_bbx.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_3/bbx_8_large/model.ckpt-16000")
...
#    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_1/test_refine_shuffle_0/model.ckpt-40000")	
    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_3/test_refine_local_8/model.ckpt-16000")
...
#    saver.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_1/test_refine_global_0/model.ckpt-1000")
	...
	g_predict,g_templates,g_states,g_original_template,LSTM_feature= sess.run([G_model.predicts,G_model.templates,G_model.cell_states,G_model.original_template,G_model.lstm_output],feed_dict= feed_dict)
        blobs = {}
        blobs['input_fea'] = LSTM_feature[0,:,:,:]
