...
#      tf.gfile.MakeDirs(FLAGS.train_dir) 
	...
	with open(FLAGS.train_file_dir) as file:
	  ...
	  Infer.define_graph()
	  file_new = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_0/'+file_name)
	  file_new.create_dataset('image',((Infer.data_handler.indices_).size,16,224,224,3))
	  file_new.create_dataset('mask',((Infer.data_handler.indices_).size,16,224,224,1))
	  ...
	  file_new.create_dataset('feature',((Infer.data_handler.indices_).size,16,14,14,512))
