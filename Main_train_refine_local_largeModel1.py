...
from params_refine_local_largeModel1 import * 
...
#      tf.gfile.MakeDirs(FLAGS.train_dir) 
	...
	saver_local = tf.train.Saver(variable_collection_local)
        saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large1/model_keep.ckpt-24")
