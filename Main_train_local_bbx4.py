...
from params_refine_bbx4 import * 
...
def main(argv=None):  # pylint: disable=unused-argument
	...
	saver_local = tf.train.Saver(variable_collection_local)
        saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large4/model.ckpt-8000")
