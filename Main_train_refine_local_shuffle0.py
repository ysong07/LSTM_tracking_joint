...
from params_refine_shuffle_0 import * 
...
def main(argv=None):  # pylint: disable=unused-argument
	...
	""" building training graph """
        ...
        saver_local.restore(sess1, "/scratch/ys1297/LSTM_tracking/source_cross_vgg_local/checkpoints/shuffle_0/cross0/model.ckpt-122000")
        #saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints/test_refine_local_0/model.ckpt-20000")
	...
	for step in range(40001):
	  ...
	  try:
	    ...
	    feature_shuffle = np.arange(512)
	    np.random.shuffle(feature_shuffle)	
	    t= time.time()
	    G_feed_dict = {output_feature_0: feature_0_no_mask[:,:,:,feature_shuffle], output_feature_1: feature_0_mask[:,:,:,feature_shuffle], ground_truth:masks,G_model.input_features:feature[:,:,:,:,feature_shuffle]}
