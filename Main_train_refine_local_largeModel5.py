...
from params_refine_local_largeModel5 import * 
...
#      tf.gfile.MakeDirs(FLAGS.train_dir) 
	...
	saver_local = tf.train.Saver(variable_collection_local)
        ...
        saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large5/model_keep.ckpt-24")
...
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_more_contaminate_large2/model.ckpt-24000")	
	...
	for step in range(6):
	  ...
	  try:
            file = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_4/'+file_list[file_id][0:-1],'r')	
	    ...
	    file_C = h5py.File('/scratch/ys1297/LSTM_tracking/data_local_vgg_refine_4/'+file_list[contaminate_id][0:-1],'r')
