...
import sys
sys.path.insert(0,'/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/anchor_gen_bbox_reg')
...
def main(argv=None):  # pylint: disable=unused-argument
	...
	tfconfig = tf.ConfigProto(allow_soft_placement=True)
        ...
        saver_bbx.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_4/test_bbx_6/model.ckpt-16000")
	...
	saver_local = tf.train.Saver(variable_collection_local)
        saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_3/test_refine_local_8/model.ckpt-8000")
	  ...
	  try:
	    ...
	    for i in range(32):
	      ...
	      print rpn_loss_cls, rpn_loss_box, total_loss		    
            #g_summary,_,g_loss,bbx_predict = sess1.run([summary,train_op,loss,fc2],feed_dict= G_feed_dict)
