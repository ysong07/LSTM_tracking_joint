...
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large2/model.ckpt-24000")
#	saver_local.restore(sess1,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_more_contaminate_large2/model.ckpt-24000")	
	...
	for step in range(40001):
	  ...
	  try:
	    ...
	    np.random.shuffle(np.asarray(contaminate_list))
...
#            scipy_io.savemat('test.mat',{'image':image_temp,'masks':masks_temp,'predict':g_predict})
