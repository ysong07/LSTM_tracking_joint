...
def train(test_file_name):
  ...
  with tf.Graph().as_default():
   ...
   # saver_bbx = tf.train.Saver(variable_collection_bbx)
    saver_bbx.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_bbx1/model.ckpt-20000")
...
#    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large1/model_keep.ckpt-24")
...
#    np.save('feature_mapping1.npy',dict_params)
#    pdb.set_trace()
###
    kernel_size_dec = []
...
#    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_contaminate_large2/model.ckpt-16000")
    ...
    saver.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_resnet_globe/checkpoints/iter_2/test_new_no_smooth_share_feature_weight_1/model.ckpt-27000")
