...
def train(test_file_name):
  ...
  with tf.Graph().as_default():
    ...
    saver_bbx.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_bbx0_2stage/model.ckpt-10000")
    pdb.set_trace()
...
#    np.save('feature_mapping0.npy',dict_params)
#    pdb.set_trace()
###
    kernel_size_dec = []
...
#    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_contaminate_large2/model.ckpt-16000")
    saver_local.restore(sess,"/scratch/ys1297/LSTM_tracking/source_cross_vgg_refine/checkpoints_5/test_refine_total_large0/model_keep.ckpt-24") 
